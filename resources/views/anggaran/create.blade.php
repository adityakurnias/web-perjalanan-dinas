<!-- resources/views/anggaran/create.blade.php -->
@extends('layouts.app')
    ...
    <div class="mdl-cell mdl-cell--6-col mdl-cell--3-offset">
        <div class="mdl-card mdl-shadow--2dp card-wide">
            <div class="mdl-card__title">
                <h2 class="mdl-card__title-text">Tambah Anggaran Baru</h2>
            </div>
            <div class="mdl-card__supporting-text">
                <form method="POST" action="{{ route('anggaran.store') }}">
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" type="number" id="tahun" name="tahun" value="{{ old('tahun', date('Y')) }}" min="2020" max="2100" required>
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <select class="mdl-textfield__input" id="bulan" name="bulan" required>
                            ...
                            @foreach($months as $key => $month)
                                <option value="{{ $key }}" {{ old('bulan') == $key ? 'selected' : '' }}>{{ $month }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" type="number" id="jumlah" name="jumlah" value="{{ old('jumlah') }}" step="0.01" min="0" required>
