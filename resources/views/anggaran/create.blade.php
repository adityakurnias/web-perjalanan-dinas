...
<div class="min-h-screen bg-violet-50 flex items-center justify-center p-4">
    <div class="max-w-lg w-full bg-white rounded-2xl shadow-lg p-8 space-y-6">
        <h2 class="text-3xl font-bold text-center text-[#6750A4]">Tambah Anggaran Baru</h2>

        <form method="POST" action="{{ route('anggaran.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="mt-1 relative">
                    ...
                    <input id="tahun" name="tahun" type="number" value="{{ old('tahun', date('Y')) }}" min="2020" max="2100" required
            ...
            <div>
                ...
                <div class="mt-1 relative">
                    ...
                    <input id="jumlah" name="jumlah" type="number" step="1000" min="0" required value="{{ old('jumlah') }}"
